...
def check_drinks(drink_name, drink_ingredients):
    ...
    """
    res = "Mocktail" if set(drink_ingredients).isdisjoint(ALCOHOLS) else "Cocktail"
    return drink_name + " " + res
...
def categorize_dish(dish_name: str, dish_ingredients: set) -> str:
    ...
    for name_cat, cat_set in categories.items():
        if dish_ingredients.issubset(cat_set):
            return dish_name + ": " + name_cat
    return "not found"
...
def singleton_ingredients(dishes, intersection):
    ...
    for ingredient in dishes:
            res.update(ingredient - intersection)
    return res


assert categorize_dish('Sticky Lemon Tofu',
                       {'tofu', 'soy sauce', 'salt', 'black pepper', 'cornstarch',
                        'vegetable oil', 'garlic', 'ginger', 'water',
                        'vegetable stock', 'lemon juice', 'lemon zest', 'sugar'}
...
result = {'arugula', 'brown sugar', 'honeydew', 'coconut water', 'english cucumber',
